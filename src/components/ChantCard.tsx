...
import { Volume2, Play, Pause, Music, Flame } from 'lucide-react';
...
export const ChantCard: React.FC<ChantCardProps> = ({ chant }) => {
  ...
  return (
    <div className="relative glass-panel rounded-3xl p-6 border border-white/10 hover:border-[#EDBB00]/50 transition-all duration-300 shadow-xl overflow-hidden group">
      ...
      <div className="flex items-start justify-between mb-4 relative z-10">
        ...
        <button
          ...
          aria-label={isPlaying ? 'Pause Audio Mockup' : 'Play Stadium Audio'}
        >
      ...
      {isPlaying && (
        <div className="mb-4 p-3 rounded-xl bg-[#004D98]/30 border border-[#EDBB00]/30 flex items-center justify-between space-x-1 animate-fadeIn">
          <div className="flex items-center space-x-2 text-xs text-[#EDBB00] font-mono">
            ...
            <span>Camp Nou Arena Audio Active...</span>
          </div>
